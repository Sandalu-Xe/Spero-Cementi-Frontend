      ...
      <article className="pt-24 lg:pt-32 pb-24">
        <div className="container mx-auto px-6 lg:px-12 max-w-5xl">
          ...
          <div className="space-y-10 mb-20">
            ...
            <h1 className="text-5xl md:text-8xl font-serif text-black dark:text-white leading-[0.9] tracking-tight">
              {post.title}
            </h1>
            ...
            <div className="space-y-8 my-20">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="aspect-[16/10] rounded-sm overflow-hidden border border-zinc-100 dark:border-zinc-900 shadow-2xl">
                  <img src={getInnovationImg1Url()} alt="Innovation Showcase 1" className="w-full h-full object-cover grayscale-[0.3] hover:grayscale-0 transition-all duration-1000" />
                </div>
                <div className="aspect-[16/10] rounded-sm overflow-hidden border border-zinc-100 dark:border-zinc-900 shadow-2xl">
                  <img src={getInnovationImg4Url()} alt="Innovation Showcase 4" className="w-full h-full object-cover grayscale-[0.3] hover:grayscale-0 transition-all duration-1000" />
                </div>
                <div className="aspect-[16/10] rounded-sm overflow-hidden border border-zinc-100 dark:border-zinc-900 shadow-xl">
                  <img src={getInnovationImg2Url()} alt="Innovation Showcase 2" className="w-full h-full object-cover grayscale-[0.3] hover:grayscale-0 transition-all duration-1000" />
                </div>
                <div className="aspect-[16/10] rounded-sm overflow-hidden border border-zinc-100 dark:border-zinc-900 shadow-xl">
                  <img src={getInnovationImg3Url()} alt="Innovation Showcase 3" className="w-full h-full object-cover grayscale-[0.3] hover:grayscale-0 transition-all duration-1000" />
                </div>
              </div>
      ...
      <section className="py-32 bg-zinc-50 dark:bg-zinc-950 border-t border-zinc-100 dark:border-white/5">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {BLOG_POSTS.filter(p => p.id !== Number(blogId)).slice(0, 2).map((other) => (
              <Link key={other.id} to={`/blog/${other.id}`} className="group flex flex-col md:flex-row gap-10 items-center bg-white dark:bg-black p-8 rounded-sm border border-zinc-100 dark:border-zinc-900 hover:border-[#00A550]/30 transition-all shadow-lg hover:shadow-2xl">

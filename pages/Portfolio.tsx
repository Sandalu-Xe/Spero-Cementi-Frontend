  ...
  return (
    <div className="bg-white dark:bg-[#0a0a0a] min-h-screen pb-24 transition-colors duration-500">
      <section className="py-20 md:py-28 container mx-auto px-6 lg:px-12 text-center">
        ...
        <RevealWords 
          text="Masterpiece Projects" 
          className="text-4xl md:text-7xl font-serif text-black dark:text-white mb-14 tracking-tighter justify-center" 
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            <FadeIn key={`${project.id}-${filter}`} delay={index * 0.1}>
              <div className="group relative overflow-hidden rounded-sm aspect-[4/5] border border-zinc-100 dark:border-zinc-900/50 shadow-2xl">
                <img 
                  src={project.img} 
                  alt={project.title} 

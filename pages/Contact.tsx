  ...
  return (
    <div className="bg-white dark:bg-[#0a0a0a] pb-24 transition-colors duration-500">
      <section className="py-24 container mx-auto px-6 lg:px-12 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-serif text-black dark:text-white">Start Your Project</h1>
      </section>
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
            <div className="space-y-4 group">
              ...
              <h4 className="text-black dark:text-white font-bold tracking-tight">Office Location</h4>
            ...
            <div className="space-y-4 group">
              ...
              <h4 className="text-black dark:text-white font-bold tracking-tight">Phone Number</h4>
              <p className="text-zinc-500 text-sm leading-relaxed">
            ...
            <div className="space-y-4 group">
              ...
              <h4 className="text-black dark:text-white font-bold tracking-tight">Email Us</h4>
              <p className="text-zinc-500 text-sm leading-relaxed">
            ...
            <div className="space-y-4 group">
              ...
              <h4 className="text-black dark:text-white font-bold tracking-tight">Working Hours</h4>
              <p className="text-zinc-500 text-sm leading-relaxed">

      ...
      <div className="relative z-10 pt-16">
        ...
        <section className="py-24 md:py-32 flex flex-col items-center">
          <div className="container mx-auto px-6 text-center max-w-4xl">
            ...
            <RevealWords 
              text="The Collection" 
              className="text-3xl md:text-5xl lg:text-6xl font-serif text-black dark:text-white leading-tight tracking-tighter mb-12 justify-center" 
            />
              ...
              <div className="container mx-auto px-6 lg:px-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-24">
                  {category.items.map((product, pIdx) => (
                    <FadeIn key={product.id} delay={pIdx * 0.1}>
                      <div className="group flex flex-col bg-transparent transition-all duration-700">
